...
<template>
  ...
  <component ref="_ref" class="ra-button" :is="tag" :autofocus="autofocus"
    ...
    <template v-if="loading">
      <slot name="loading">
        <ra-icon class="loading-icon" :icon="loadingIcon ?? 'spinner'" :style="iconStyle" size="1x" spin />
      </slot>
    </template>

    <ra-icon v-if="icon && !loading" :icon="icon" :style="iconStyle" size="1x" />
